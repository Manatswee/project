...
// สร้างตัวแปรเพื่อติดตามสถานะการทำข้อสอบ
...
quizForm.addEventListener('submit', function(e) {
    ...
    isSubmitted = true; // กำหนดว่าได้ทำการ submit แล้ว
...
function getUserAnswers() {
    return [
        quizForm.q1.value, quizForm.q2.value, quizForm.q3.value, quizForm.q4.value, quizForm.q5.value,
        quizForm.q6.value, quizForm.q7.value, quizForm.q8.value, quizForm.q9.value, quizForm.q10.value,
        quizForm.q11.value, quizForm.q12.value, quizForm.q13.value, quizForm.q14.value, quizForm.q15.value,
        quizForm.q16.value, quizForm.q17.value, quizForm.q18.value, quizForm.q19.value, quizForm.q20.value
    ];
}

// เพิ่มการตรวจสอบเพื่อให้สามารถกด Finish ได้เมื่อทำครบทุกข้อและได้ทำการ submit
const finishButton = document.getElementById('button1');
finishButton.addEventListener('click', function() {
    ...
    // ตัวอย่างเช่น redirect ไปที่หน้าหลัก
