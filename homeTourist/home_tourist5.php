...
<body>
    ...
    function checkKeywords(transcript) {
        const keywords = ["tourist information counter", "Tourist information counter",
            "at the tourist information counter", "At the tourist information counter",
            "at the tourist information", "At the tourist information", "at the Tourist Information",
            "Tourist information", "tourist information", "hiking", "Hiking", "bird watching", "Bird watching",
            "enjoying panoramic view", "Enjoying view", "enjoying view", "Enjoying panoramic view", "Yes", "yes",
            "Maybe", "maybe", "tuk-tuk", "Tuk-Tuk", "motorcycle", "Motorcycle"
        ];
    ...
    submitButton.addEventListener('click', () => {
        if (!output1.innerHTML || !output2.innerHTML || !output3.innerHTML || !output4.innerHTML) {
            ...
            if (!buttonClicked) {
                ...
                const apiUrl_saveData = 'http://localhost/Projesct12/api/api-productiontourist';
