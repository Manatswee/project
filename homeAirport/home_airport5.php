            ...
            <article>
                ...
                <div class="article-preview">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question2:</h4> How long does the minivan take to get to the city center?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question3:</h4> How much does a minivan cost to get to the city center?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question4:</h4> How much does a public bus cost to get to the city center?
                                <br><br>
                                <div class="controls">
