...
<body>
    ...
    <form action="home_tourist3.php">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Most of these attractions are easily
                                    ...
                                    accessible </a> by tuk-tuk (a local two row minibus) from the city center. If you can ride a motorcycle, you can also rent a motorcycle for more flexibility. How long would you like
                                    to stay there?
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="button-container">
            <button formaction="home_tourist1.php" id="button1">Back</button>
            <button>Next</button>
        </div>
    </form>
</body>
