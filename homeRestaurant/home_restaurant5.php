            ...
            <article>
                ...
                <div class="article-preview">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question1:</h4> What does the customers do at the restaurant?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question2:</h4> Do the customers have their reservation?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question3:</h4> Does the customers get the table?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question4:</h4> Do the customers like their meals?
                                <br><br>
                                <div class="controls">
