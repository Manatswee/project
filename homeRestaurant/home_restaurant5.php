        ...
        <!-- <form action="../home/home.php"> -->
            ...
            <script>
                ...
                function checkKeywords(transcript) {
                    const keywords = ["They want to order food", "they want to order food", "Order food", "order food", "Order Food", "Get something to eat", "get something to eat", "No, they do not", "No, they don't", "No", "no"];
