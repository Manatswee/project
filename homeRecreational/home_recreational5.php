...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="home_recreational5.css">
    </head>
    ...
    <body>
        ...
        <!-- <form action="../home/home.php"> -->
                        ...
                        <div class="article-preview">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="left">
                                        ...
                                        <div class="controls">
                                            ...
                                            <audio id="audioA" src="../sound/ProductionU2Q1.mp3"></audio>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="left">
                                        <h4>Question2:</h4>
                                        <!-- What are activities recommendations by the travel agent? -->
                                        <br><br>
                                        <div class="controls">
                                            <button id="positionB">Play</button>
                                            <audio id="audioB" src="../sound/ProductionU2Q2.mp3"></audio>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="left">
                                        <h4>Question3:</h4>
                                        <!-- Does the tourist interested in doing kayaking right away? -->
                                        <br><br>
                                        <div class="controls">
                                            <button id="positionC">Play</button>
                                            <audio id="audioC" src="../sound/ProductionU2Q3.mp3"></audio>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="left">
                                        <h4>Question4:</h4>
                                        <!-- How much does the kayaking package cost? -->
                                        <br><br>
                                        <div class="controls">
                                            <button id="positionD">Play</button>
                                            <audio id="audioD" src="../sound/ProductionU2Q4.mp3"></audio>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <!-- <script src="home_recreational5.js"></script> -->
                        </div>
                    </article>
            ...
            <div class="button-container">
                <button form action="home_recreational4.php" id="button1">Back</button>
            ...
            <script>
                ...
                function checkKeywords(transcript) {
                    const keywords = ["at the tour office", "At the tour office", "at the tour Office", "tour office", "Tour office", "The tour office", "beach activities", "Beach activities", "swim", "Swim", "swimming", "Swimming", "kayaking", "Kayaking", "No, he prefers to relax first", "No he doesn’t", "No", "no"];
                ...
                submitButton.addEventListener('click', () => {
                    ...
                    // URL ของ API
                    const apiUrl_saveData = 'http://localhost/Projesct12/api/api-production2.php';

                    // ข้อมูลที่ต้องการบันทึก
                    const postData = {
                        user_name: userData,
                        production_2: output1.innerHTML,
                        production_2_2: output2.innerHTML,
                        production_2_3: output3.innerHTML,
                        production_2_4: output4.innerHTML,
                        score_2: totalScore,
                    };
