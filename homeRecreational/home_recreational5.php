            ...
            <article>
                ...
                <div class="article-preview">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question2:</h4> What are activities recommendations by the travel agent?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question3:</h4> Does the tourist interested in doing kayaking right away?
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question4:</h4> How much does the kayaking package cost?
                                <br><br>
                                <div class="controls">
