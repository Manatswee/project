...
<body>
    ...
    function checkKeywords(transcript) {
        const keywords = ["at the tour office", "At the tour office", "at the tour Office", "tour office",
            "Tour office", "The tour office", "beach activities", "Beach activities", "swim", "Swim", "swimming",
            "Swimming", "kayaking", "Kayaking", "No, he prefers to relax first", "No he doesn’t", "No", "no"
        ];
    ...
    submitButton.addEventListener('click', () => {
        if (!output1.innerHTML || !output2.innerHTML || !output3.innerHTML || !output4.innerHTML) {
            ...
            if (!buttonClicked) {
                ...
                const apiUrl_saveData = 'http://localhost/Projesct12/api/api-productionactivities';
