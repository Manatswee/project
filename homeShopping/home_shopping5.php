...
<body>
                ...
                <div class="article-preview">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question1:</h4>
                                <!-- What does the tourist need help with? -->
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question2:</h4>
                                <!-- What are the souvenirs offered at the shop? -->
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question3:</h4>
                                <!-- What are the items the tourist buy? -->
                                <br><br>
                                <div class="controls">
                        ...
                        <tr>
                            <td class="left">
                                <h4>Question4:</h4>
                                <!-- How much does the tourist pay in total ? -->
                                <br><br>
                                <div class="controls">
    ...
    <div class="button-container">
        <button form action="home_shopping4.php" id="button1">Back</button>
    ...
    function checkKeywords(transcript) {
        const keywords = ["The tourist looks for souvenirs to bring back home",
            "looks for souvenirs to bring back home", "Looks for souvenirs to bring back home",
            "souvenirs to bring back home", "Souvenirs to bring back home", "traditional handicrafts",
            "Traditional handicrafts", "batik painting", "Batik painting", "T-shirts", "local snacks",
            "seashell jewelry", "Seashell Jewelry", "Batik T-shirts", "Local snacks",
            "Batik T-shirts and local snacks", "900", "900 Baht", "Sourenirs to bring home",
            "sourenirs to bring home"
        ];
    ...
    submitButton.addEventListener('click', () => {
        if (!output1.innerHTML || !output2.innerHTML || !output3.innerHTML || !output4.innerHTML) {
            ...
            if (!buttonClicked) {
                ...
                const apiUrl_saveData = 'http://localhost/Projesct15/api/api-productionshopping';
